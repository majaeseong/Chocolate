...
public class HomeController {
	...
	@ResponseBody public List<ProductDTO> scroll_page(@RequestParam(required=false, defaultValue="1") int pageNum,
	...
	public String addtocart(@RequestParam(required=false) int amount,
	...
	public String order_page(HttpServletRequest request, HttpSession session,
			@RequestParam int total,@RequestParam String addr,Model model) throws Exception{
	...
	public String editsuccess(@RequestParam String originalImage,
			@RequestParam MultipartFile file, ProductDTO pdto){
	...
	public String changeChoery(@RequestParam int id, @RequestParam int choery) throws Exception{
	...
	public String writeReview(@RequestParam int pid,
			@RequestParam int orderdetailid, Model model) throws Exception{
	...
	public String writeReview(ReviewDTO rdto, Model model, HttpSession session,
			@RequestParam MultipartFile file, @RequestParam int orderdetailid){
	...
	public String updateReview2(ReviewDTO rdto, @RequestParam MultipartFile file,
			@RequestParam String originalImage,Model model){
